...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const pageTitle = buildPageTitle([data?.meta_title, t("about_title")], "Sportoonline");
  const pageDescription = buildMetaDescription([data?.meta_description, t("about_description")]);
