...
- [X] Kullanıcı onayıyla #237 mükerrer 387 TL tahsilat iyzico'dan iptal edildi (`paymentId=4210882766`, sonuç `success`, tutar 387 TRY). Korunacak #238 siparişi `paid` ve onaylı durumda kaldı. İptal denetim kaydı: `storage/app/backups/iyzico-cancel-duplicate-237-20260921.json`. PR: https://github.com/Orhanguezel/quickecommerce/pull/23 (taslak; #22 üzerine).
