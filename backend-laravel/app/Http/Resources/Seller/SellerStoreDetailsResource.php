...
class SellerStoreDetailsResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            "profile_completion_score" => (int) $this->profile_completion_score,
            "shipping_sla_hours" => (int) $this->shipping_sla_hours,
            "sales_suspended_at" => $this->sales_suspended_at,
            "sales_suspension_reason" => $this->sales_suspension_reason,
