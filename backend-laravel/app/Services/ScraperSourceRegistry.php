...
class ScraperSourceRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['name' => 'herbinatura',         'platform' => 'IdeaSoft',                           'site_url' => 'https://www.herbinatura.com',           'status' => self::STATUS_PASSIVE, 'db_source_name' => 'herbinatura',         'notes' => '2026-07-27 PASIF (kullanici karari: stok sorunu olacak kaynaklari acma). KANIT: 8 urun sayfasinin 8inde de JSON-LD availability alani YOK; herbinatura_scraper.py:158 alan bosken "stokta" varsayiyor (in_stock = ... or avail == "") -> 45/45 urun daima stokta gorunuyor, yok satma riski. UYARI: pasife almak tek basina riski bitirmez — urunler sitede stokta gorunmeye devam eder. Kalici cozum: sayfadaki sepete-ekle/tukendi CSS gostergesinden fail-closed tespit.'],
