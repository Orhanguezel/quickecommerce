...
class ScraperSourceRegistry
{
    ...
    public static function all(): array
    {
        return [
            // === Aktif kaynaklar ===
            ['name' => 'heyday', 'platform' => 'ikas (Next.js embedded product data)', 'site_url' => 'https://heydaytr.com', 'status' => self::STATUS_ACTIVE, 'db_source_name' => 'heyday', 'notes' => 'Separate Heyday store; exact variant stock and TRY list/discount prices from public ikas product data.'],
            ['name' => 'neptun', 'platform' => 'Custom server-rendered catalog', 'site_url' => 'https://www.neptun.com.tr/urunler', 'status' => self::STATUS_ACTIVE, 'db_source_name' => 'neptun', 'notes' => 'Separate Neptün store; public add-to-basket control is used as fail-closed stock evidence.'],
