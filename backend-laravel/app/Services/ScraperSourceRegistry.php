...
class ScraperSourceRegistry
{
    ...
    public static function all(): array
    {
        return [
            ...
            ['name' => 'floky',               'platform' => 'Shopify',                            'site_url' => 'https://floky.tr',                      'status' => self::STATUS_ACTIVE, 'db_source_name' => 'floky',               'notes' => 'Floky Socks — kaydirmaz/spor corap (2026-06-17 eklendi)'],
