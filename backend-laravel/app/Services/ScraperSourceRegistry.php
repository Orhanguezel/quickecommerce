...
class ScraperSourceRegistry
{
    ...
    public static function all(): array
    {
        return [
            // === Aktif kaynaklar ===
            ['name' => 'heynut', 'platform' => 'Ticimax (local Scrapling)', 'site_url' => 'https://www.heynut.com.tr', 'status' => self::STATUS_ACTIVE, 'db_source_name' => 'heynut', 'notes' => 'Separate HeynuT store; explicit per-variant stock and VAT-inclusive prices.'],
            ['name' => 'raketspor_yonex', 'platform' => 'Ticimax (local Scrapling)', 'site_url' => 'https://www.raketspor.com.tr/yonex', 'status' => self::STATUS_ACTIVE, 'db_source_name' => 'raketspor_yonex', 'notes' => 'Only verified Yonex products; destination Multiprice #41.'],
            ...
            ['name' => 'dekomum',             'platform' => 'WooCommerce Store API',              'site_url' => 'https://dekomum.com',                   'status' => self::STATUS_ACTIVE, 'db_source_name' => 'dekomum',             'stock_signal_verified' => true, 'notes' => 'INT stok native. 2026-08-29 STOK TESPITI DOGRULANDI: WooCommerce Store API is_in_stock alanini gercekten okuyor (dekomum_scraper.py:193). \"stock_status=outofstock\" sorgusu 0 urun donuyor — magazada su an gercekten tukenmis urun yok, parser fail-open DEGIL.'],
            ['name' => 'maskotmeyvepresleri', 'platform' => 'WooCommerce',                        'site_url' => 'https://www.maskotmeyvepresleri.com',  'status' => self::STATUS_PASSIVE, 'db_source_name' => 'maskotmeyvepresleri', 'notes' => '2026-09-21 KALDIRILDI (kullanici karari): store#56 ve 45 urunun tamami soft-delete. Gunluk scraper zincirinden cikarildi; health-check bu kaynagi uyarmamali.'],
            ...
            ['name' => 'ortholand',           'platform' => 'Static manufacturer catalog',        'site_url' => 'https://www.ortholand.com.tr',           'status' => self::STATUS_PASSIVE, 'db_source_name' => 'ortholand',          'notes' => '2026-09-21 PASIF: yalniz product #411 icin 9 eski mapping vardi. Kaynak sayfasi fiyat veya stok sunmuyor; urun manuel yonetime alindi ve kaynak mappingleri yedeklenip kaldirildi.'],
