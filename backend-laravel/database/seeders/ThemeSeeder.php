    ...
    public function run(): void
    {
        ...
        $enThemePages = [
            [
                'theme_home_page' => [
                    [
                        'section_order'           => ['slider', 'category', 'flash_sale', 'product_featured', 'banner_section', 'product_latest', 'product_top_selling', 'popular_product_section', 'blog_section', 'top_stores_section', 'newsletters_section'],
                        'layout_blocks'          => [
                ...
                'theme_popup_settings' => [
                    [
                        ...
                        'popup_bg_color' => '#0F766E',
                        'popup_text_color' => '#F0FDFA',
                        'popup_button_bg_color' => '#F0FDFA',
                        'popup_button_text_color' => '#115E59',
                    ],
                    [
                    ...
                    [
                        ...
                        'text_behavior' => 'static',
                        'popup_bg_color' => '#7C2D12',
                        'popup_text_color' => '#FFEDD5',
                        'popup_button_bg_color' => '#FDBA74',
                        'popup_button_text_color' => '#7C2D12',
                    ],
                    [
                        ...
                        'display_type' => 'top_bar',
                        'text_behavior' => 'marquee',
                        'popup_bg_color' => '#7C3AED',
                        'popup_text_color' => '#F5F3FF',
                        'popup_button_bg_color' => '#DDD6FE',
                        'popup_button_text_color' => '#5B21B6',
                    ],
                    [
