...
class ProductSeeder extends Seeder
{
    ...
    private function getProducts(): array
    {
        return [
            ...
            // ============ SUPPLEMENT (Protein34) ============
            [
                'tr' => ['name' => 'Whey Isolate Protein 1800g', 'description' => 'İzole whey protein. Düşük yağ ve karbonhidrat, her serviste 27g saf protein. Hızlı emilim formülü.'],
                'en' => ['name' => 'Whey Isolate Protein 1800g', 'description' => 'Isolated whey protein. Low fat and carbs, 27g pure protein per serving. Fast absorption formula.'],
                'category' => 'proteinler',
                'brand' => 'olimp',
                'store' => 'protein34',
                'unit' => 'kilogram',
                'price' => 2800,
                'image' => 'https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=600',
                'tags' => ['cok-satan', 'protein', 'kas-yapma'],
                'variants' => [
                    ['name' => 'Çikolata', 'sku' => 'P34-WI-CHO-1800', 'price' => 2800, 'stock' => 40],
                    ['name' => 'Vanilya', 'sku' => 'P34-WI-VAN-1800', 'price' => 2800, 'stock' => 35],
                    ['name' => 'Kahve', 'sku' => 'P34-WI-COF-1800', 'price' => 2800, 'stock' => 30],
                ],
            ],
            [
                'tr' => ['name' => 'BCAA 4:1:1 Tablet 200 Adet', 'description' => 'Tablet formda BCAA. 4:1:1 lösin ağırlıklı oran. Kas koruma ve toparlanma desteği.'],
                'en' => ['name' => 'BCAA 4:1:1 Tablets 200 Count', 'description' => 'BCAA in tablet form. 4:1:1 leucine-heavy ratio. Muscle protection and recovery support.'],
                'category' => 'bcaa-aminoasitler',
                'brand' => 'bigjoy',
                'store' => 'protein34',
                'unit' => 'adet',
                'price' => 950,
                'image' => 'https://images.unsplash.com/photo-1579722821273-0f6c7d44362f?w=600',
                'tags' => ['bcaa', 'antrenman', 'kas-yapma'],
                'variants' => [
                    ['name' => '200 Tablet', 'sku' => 'P34-BCAA-200', 'price' => 950, 'stock' => 55],
                ],
            ],
            [
                'tr' => ['name' => 'Micronized Kreatin 400g', 'description' => 'Mikronize kreatin monohidrat. Daha iyi çözünürlük ve emilim. Sertifikalı hammadde.'],
                'en' => ['name' => 'Micronized Creatine 400g', 'description' => 'Micronized creatine monohydrate. Better solubility and absorption. Certified raw material.'],
                'category' => 'kreatin',
                'brand' => 'hardline-nutrition',
                'store' => 'protein34',
                'unit' => 'gram',
                'price' => 750,
                'image' => 'https://images.unsplash.com/photo-1594381898411-846e7d193883?w=600',
                'tags' => ['kreatin', 'guc', 'fitness'],
                'variants' => [
                    ['name' => 'Aromasız', 'sku' => 'P34-MCR-400', 'price' => 750, 'stock' => 70],
                ],
            ],
            [
                'tr' => ['name' => 'Nitro Pump Pre-Workout 400g', 'description' => 'Yüksek dozajlı pre-workout formülü. L-Arginin, Beta-Alanin, Kafein. Maksimum pompa ve odaklanma.'],
                'en' => ['name' => 'Nitro Pump Pre-Workout 400g', 'description' => 'High-dose pre-workout formula. L-Arginine, Beta-Alanine, Caffeine. Maximum pump and focus.'],
                'category' => 'pre-workout',
                'brand' => 'olimp',
                'store' => 'protein34',
                'unit' => 'gram',
                'price' => 1100,
                'image' => 'https://images.unsplash.com/photo-1517836357463-d25dfeac3438?w=600',
                'tags' => ['pre-workout', 'antrenman', 'guc'],
                'variants' => [
                    ['name' => 'Yeşil Elma', 'sku' => 'P34-NP-GA-400', 'price' => 1100, 'stock' => 35],
                    ['name' => 'Portakal', 'sku' => 'P34-NP-ORA-400', 'price' => 1100, 'stock' => 30],
                ],
            ],
            [
                'tr' => ['name' => 'Multivitamin Sport 90 Tablet', 'description' => 'Sporcular için özel multivitamin. 25 vitamin ve mineral. Günlük ihtiyacın %100\'ünü karşılar.'],
                'en' => ['name' => 'Sport Multivitamin 90 Tablets', 'description' => 'Special multivitamin for athletes. 25 vitamins and minerals. Meets 100% of daily needs.'],
                'category' => 'vitamin-mineraller',
                'brand' => 'solgar',
                'store' => 'protein34',
                'unit' => 'adet',
                'price' => 680,
                'image' => 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=600',
                'tags' => ['vitamin', 'mineral', 'fitness'],
                'variants' => [
                    ['name' => '90 Tablet', 'sku' => 'P34-MV-90', 'price' => 680, 'stock' => 60],
                ],
            ],
            [
                'tr' => ['name' => 'Kazein Protein Gece Formülü 1000g', 'description' => 'Yavaş salınımlı kazein protein. Gece boyunca kas beslenmesi. 8 saat amino asit salınımı.'],
                'en' => ['name' => 'Casein Protein Night Formula 1000g', 'description' => 'Slow-release casein protein. Overnight muscle nutrition. 8-hour amino acid release.'],
                'category' => 'proteinler',
                'brand' => 'hardline-nutrition',
                'store' => 'protein34',
                'unit' => 'kilogram',
                'price' => 1900,
                'image' => 'https://images.unsplash.com/photo-1593095948071-474c5cc2989d?w=600',
                'tags' => ['protein', 'kas-yapma', 'premium'],
                'variants' => [
                    ['name' => 'Çikolata', 'sku' => 'P34-KZ-CHO-1000', 'price' => 1900, 'stock' => 25],
                    ['name' => 'Vanilya', 'sku' => 'P34-KZ-VAN-1000', 'price' => 1900, 'stock' => 20],
                ],
            ],
