...
class BannerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $shopProductsUrl = 'http://localhost:3003/tr/urunler';
        $categoriesUrl = 'http://localhost:3003/tr/kategoriler';
        $featuredCategoryUrl = 'http://localhost:3003/tr/kategori/kamp-outdoor';
        ...
        $banners = [
            ...
            [
                ...
                'title_color' => $themeOneBannerTokens['title'],
                'description_color' => $themeOneBannerTokens['description'],
                'background_color' => $themeOneBannerTokens['surface'],
                'background_image' => '',
                'thumbnail_image' => '/images/banner-illustration.png',
                'button_text_color' => $themeOneBannerTokens['button_text'],
                'button_hover_color' => $themeOneBannerTokens['button_hover'],
                'button_color' => $themeOneBannerTokens['button'],
                'redirect_url' => $shopProductsUrl,
                'location' => 'home_page',
                'type' => 'banner_one',
            ],
            ...
            [
                ...
                'button_hover_color' => $themeOneBannerTokens['button_hover'],
                'button_color' => $themeOneBannerTokens['button'],
                'redirect_url' => $featuredCategoryUrl,
                'location' => 'home_page',
                'type' => 'banner_one',
            ],
