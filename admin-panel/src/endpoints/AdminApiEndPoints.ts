export const API_ENDPOINTS = {
  ...
  SELLER_DELIVERY_DROPDOWN_LIST: "v1/seller/store/deliveryman/list-dropdown",
  ...
  ADMIN_SELLER_APPLICATION_RETRY_SUBMERCHANT: "v1/admin/seller/applications/retry-submerchant",
